...
Данный микросервис позволяет управлять событиями (создавать, обновлять, удалять), также реализована возможность управлять командой события (добавлять пользователей в команду, обновлять и удалять их).
...
• ***GET*** _/events/{eventId}/teams_ - получение всей команды указанного события;

• ***PATCH*** _/events/{eventId}/teams/members/{memberId}_ - обновление роли пользователя в команде события;

• ***DELETE*** _/events/{eventId}/teams/members/{memberId}_ - удаление пользователя из команды события;
...
_http://localhost:8070/swagger-ui/index.html_
